...
class LaporanPenyesuaian extends BaseController
{
    public function index()
    {
        ...
        $builder = $model->select('detail_penyesuaian_stok.*, ps.nomor_penyesuaian, ps.tanggal, ps.jenis_penyesuaian, ps.keterangan as ket_umum, b.nama_barang, b.satuan, COALESCE(batch.bisa_dipecah, b.bisa_dipecah) as bisa_dipecah, batch.nomor_batch, batch.tanggal_kedaluwarsa')
