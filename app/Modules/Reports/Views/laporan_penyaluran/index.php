...
<style>
    ...
    .wh-toolbar-count .num {
        font-size: 1.1rem;
        font-weight: 700;
        color: var(--wh-text);
    }
    .wh-toolbar-count .lbl {
        font-size: 0.8rem;
        color: var(--wh-text-soft);
        margin-left: 6px;
    }
    .wh-toolbar-actions { display: flex; gap: 8px; flex-wrap: wrap; }
    .wh-tb-btn {
        height: 40px;
        border-radius: 10px;
        border: 1px solid var(--wh-border);
...
<div class="wh-page">
    ...
    <div class="wh-table-card">
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0" id="tabelPenyaluran">
                <thead>
                    <tr>
                    ...
                    <?php else: ?>
                        <?php $no = 1; foreach ($laporan as $item) : ?>
                            ...
                            <tr>
                                ...
                                <td class="text-end" style="font-weight:500;"><?= $totalKg > 0 ? format_berat($totalKg, 'Kg') : '-' ?></td>
