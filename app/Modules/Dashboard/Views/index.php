...
<style>
    ...
    *::after {
    ...
    .wb {
        ...
        --border-focus: #D1D5DB;
        --text: #111827;
        Saya akan memeriksa view yang disebutkan dan mencatat wrapper terluar setelah section('content'),
        tanpa mengubah file apa pun. Saya mulai dari pencarian nama file lalu membaca bagian awal masing-masing view. Struktur proyek memakai module views,
        jadi beberapa nama yang diminta berada di bawah app/Modules/.../Views/,
        bukan Views. Saya sudah menemukan semua kandidat utama;
        berikutnya saya ambil pembuka file seca --muted: #6B7280;
        --subtle: #9CA3AF;
        --green: #16A34A;
        --green-bg: #DCFCE7;
        --amber: #D97706;
    ...
    @media (max-width: 900px) {
        ...
        .wb-tile:nth-child(2n) {
            border-right: none;
        }

        .wb-tile:nth-child(n+3) {
            border-top: 1px solid var(--border);
        }
...
<div class="wb">
    ...
    <div class="wb-header">
        ...
        <div class="wb-header-right">
            ...
            <span id="liveSyncStatus" class="wb-date mt-1"
                style="color: #16a34a; font-size: 10.5px; font-weight: 600;"><i class="bi bi-broadcast me-1"
                    id="liveSyncIcon"></i>Live Sync Active</span>
        </div>
    </div>
        ...
        <div class="wb-card">
            ...
            <div class="wb-summary-grid">
                <div class="wb-tile">
                    ...
                    <div class="wb-tile-val" id="tileTotalBeratGudang"><?= format_berat($totalBeratGudang, 'Kg') ?>
                    </div>
                    <div class="wb-tile-unit">Seluruh stok tersedia</div>
                </div>
                <div class="wb-tile">
                    <div class="wb-tile-label">Total Donatur</div>
                    <div class="wb-tile-val" id="tileTotalDonatur"><?= number_format($totalDonatur, 0, ',', '.') ?>
                    </div>
                    <div class="wb-tile-unit">Donatur terdaftar</div>
                </div>
                <div class="wb-tile">
                    <div class="wb-tile-label">Titik Penyaluran</div>
                    <div class="wb-tile-val" id="tileTotalWilayah"><?= number_format($totalWilayah, 0, ',', '.') ?>
                    </div>
                    <div class="wb-tile-unit">Wilayah target</div>
                </div>
                <div class="wb-tile">
                    <div class="wb-tile-label">Total Kategori</div>
                    <div class="wb-tile-val" id="tileTotalKategori"><?= number_format($totalKategori, 0, ',', '.') ?>
                    </div>
                    <div class="wb-tile-unit">Klasifikasi barang</div>
                </div>
                <div class="wb-tile">
                    <div class="wb-tile-label">Batch Kadaluwarsa</div>
                    <div class="wb-tile-val" id="tileBatchKadaluwarsa" style="color:var(--red)">
                        <?= number_format($countExpired, 0, ',', '.') ?>
                    </div>
                    <div class="wb-tile-unit">Sudah melewati tanggal</div>
                </div>
                <div class="wb-tile">
                    <div class="wb-tile-label">Hampir Kadaluwarsa</div>
                    <div class="wb-tile-val" id="tileHampirKadaluwarsa" style="color:var(--amber)">
                        <?= number_format($countHampirExpired, 0, ',', '.') ?>
                    </div>
        ...
        <div class="wb-card">
            ...
            <div class="wb-exp-row">
                <div class="wb-exp-tile">
                    ...
                    <div>
                        <div class="wb-exp-num" id="expTileExpired" style="color:var(--red)">
                            <?= number_format($countExpired, 0, ',', '.') ?> <small
                                style="font-size:.75rem;font-weight:400;color:var(--muted)">Batch</small>
                        </div>
                ...
                <div class="wb-exp-tile">
                    ...
                    <div>
                        <div class="wb-exp-num" id="expTileHampirExpired" style="color:var(--amber)">
                            <?= number_format($countHampirExpired, 0, ',', '.') ?> <small
                                style="font-size:.75rem;font-weight:400;color:var(--muted)">Batch</small>
                        </div>
                ...
                <div class="wb-exp-tile">
                    ...
                    <div>
                        <div class="wb-exp-num" id="expTileAman" style="color:var(--green)">
                            <?= number_format($countAman, 0, ',', '.') ?> <small
                                style="font-size:.75rem;font-weight:400;color:var(--muted)">Batch</small>
                        </div>
                ...
                <table class="wb-table">
                    ...
                    <tbody id="tbodyHampirExpired">
                        <?php if (empty($hampirExpiredList)): ?>
                            <tr>
                                <td colspan="4" style="text-align:center;padding:2rem;color:var(--muted)">Tidak ada data
                                    barang yang akan kedaluwarsa.</td>
                            </tr>
                        <?php else: ?>
                            <?php foreach ($hampirExpiredList as $item): ?>
                                <tr>
                                    ...
                                    <td style="color:var(--muted)"><?= date('d M Y', strtotime($item['tanggal_kedaluwarsa'])) ?>
                                    </td>
                                    <td>
                    ...
                    <table class="wb-table">
                        ...
                        <tbody id="tbodyTopBarang">
                            <?php if (empty($topBarang)): ?>
                                <tr>
                                    <td colspan="5" style="text-align:center;padding:2rem;color:var(--muted)">Belum ada
                                        stok.</td>
                                </tr>
                            <?php else: ?>
                                <?php $no = 1;
                                foreach ($topBarang as $b): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                class="wb-badge blue"><?= number_format($b['total_stok'], 0, ',', '.') ?></span>
                                        </td>
                                        <td style="color:var(--muted)"><?= esc($b['satuan']) ?></td>
                                        <td style="text-align:right;font-weight:500">
                                            <?= format_berat($b['total_berat'], 'Kg') ?>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php endif; ?>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const gridColor = isDarkMode ? 'rgba(148,163,184,.22)' : '#D1D5DB';
        const tickColor = isDarkMode ? '#CBD5E1' : '#64748B';
        const legendColor = isDarkMode ? '#CBD5E1' : '#374151';
        ...
        const kategoriChartObj = new Chart(document.getElementById('kategoriChart'), {
            ...
            options: {
                ...
                plugins: {
                    legend: {
                        position: 'bottom',
                        labels: { usePointStyle: true, padding: 16, color: legendColor, font: { size: 11 } }
                    },
                    tooltip: {
                        ...tooltip,
                        callbacks: {
